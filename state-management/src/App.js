...
function App() {
  ...
  return (
    <div className='App'>
      <div class='p-5'>
        <fieldset>
          <legend class='text-bold'>Guess the Number</legend>
          <div class='d-flex justify-content-around'>
            <div>
              <div class='p-2' style={{ width: '100%' }}>
                <div class='row'>
                  <div class='col-8'>
                    <span class='text-secondary h1 mb-2 mx-5'>
                      {values.random1}
                    </span>
                    <span class='text-secondary h1 mb-2 mx-5'>
                      {values.random2}
                  ...
                  <button
                    class='col-4 btn btn-info text-light btn-sm'
            ...
            <div class='d-flex flex-column justify-content-between'>
              <div class='d-flex text-success justify-content-center mb-5'>
